...
export function Pagination({
    ...
    const btnBase =
        "w-8 h-8 flex items-center justify-center rounded-lg border border-gray-200 text-gray-500 hover:bg-gray-50 disabled:opacity-30 disabled:cursor-not-allowed transition-colors";
            ...
            <div className="flex items-center gap-3 flex-wrap">
                ...
                <div className="flex items-center gap-1.5">
                    ...
                    <SegmentedControl
                        ...
                        onChange={(v: string) => {
                            onPageSizeChange(v === "all" ? null : Number(v));
                            onPageChange(1);
                        }}
                    />
                </div>
