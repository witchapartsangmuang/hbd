...
export default function SlideInIconEditor({ content, hidden, sectionId }: SectionEditorProps) {
    const [slideInTitle, setSlideInTitle] = useState(content.slideInIcon?.[sectionId]?.title ?? "");
