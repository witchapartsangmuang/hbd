...
export default function CandleBlow({
    ...
    const { candleCount, message } = content.candleBlow;
    ...
    return (
        <section className="flex min-h-screen flex-col items-center justify-center gap-6 bg-linear-to-b from-amber-50 via-(--theme-softer) to-(--theme-soft) p-4 sm:gap-8 sm:p-6">
            <div className="text-center">
                ...
                <h2 className="mt-1 text-2xl font-bold text-slate-800 sm:text-3xl">Blow Out the Candles 🕯️</h2>
                        ...
                        return (
                            <div key={i} className="flex flex-col items-center">
                                <span
                                    ...
                                    style={{ boxShadow: isLit ? "0 0 12px 4px rgba(251,146,60,.7)" : "none" }}
                                />
