...
export default function MemoryTimeline({
    ...
    const { items } = content.memoryTimeline;
    ...
    return (
        <section className="flex min-h-screen flex-col items-center justify-center gap-6 bg-linear-to-b from-(--theme-softer) via-(--theme-softer) to-white p-4 sm:gap-8 sm:p-6">
            <div className="text-center">
                ...
                <h2 className="mt-1 text-2xl font-bold text-slate-800 sm:text-3xl">Memory Timeline 🕰️</h2>
            </div>
                    ...
                    {items.map((item, i) => (
                        ...
                        >
                            ...
                            <div className="text-center sm:text-left">
                                <p className="text-sm font-bold text-(--theme-primary)">{item.year}</p>
