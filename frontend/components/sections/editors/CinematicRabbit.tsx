...
export default function CinematicRabbit({
    ...
    const { title, subtitle } = content.cinematicRabbit;
    ...
    return (
        <section
            ref={containerRef}
            className="relative flex min-h-screen flex-col items-center justify-center gap-4 overflow-hidden bg-linear-to-br from-sky-50 via-(--theme-softer) to-white px-4 py-10 text-center sm:gap-6 sm:px-6 sm:py-16"
        >
            <style jsx>{`
                @keyframes hop-in {
                    0% {
            ...
            >
                <span
                    ...
                    style={isVisible ? { animation: "ear-wiggle 1200ms ease-in-out 1400ms infinite" } : undefined}
                >
                    🐰
                </span>
            </div>
