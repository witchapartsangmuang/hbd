...
import { brushRadius, revealThreshold } from "../draft/utils/data";
import { confettiState, scratchCardState } from "../draft/utils/hooks";
import { launchConfetti } from "../draft/utils/functions";
...
export default function ScratchCard({
  ...
  const revealSuccess = () => {
    ...
    // พยายามเปิดวิดีโอพร้อมเสียงทันทีหลังขูดสำเร็จ
    setTimeout(() => {
      setShowVideo(true);
    }, 220);
  };
